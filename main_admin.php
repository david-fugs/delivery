    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-center lead mb-5">Bienvenido, <?php echo htmlspecialchars($_SESSION["user_name"]); ?></p>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="dashboard-card">
                    <h4 class="mb-3"><i class="fa-solid fa-dollar-sign"></i> Ingresos del Mes</h4>
